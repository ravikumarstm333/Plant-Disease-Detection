...
const Dashboard = () => {
  ...
  const marketManagerSections = [
    {
      title: 'Manage Vegetable Prices',
      description: 'Set and update official market prices for vegetables',
      icon: '💰',
      link: '/market',
      color: '#4caf50'
    },
    {
      ...
      description: 'Review and approve farmer vegetable listings',
      icon: '✅',
      link: '/market',
      color: '#2196f3'
    },
    {
      ...
      description: 'View market trends and statistics',
      icon: '📊',
      link: '/market',
      color: '#ff9800'
    }
